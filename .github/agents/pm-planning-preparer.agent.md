...
- All tools listed in the `tools` front matter are already available — do NOT attempt to search for them with "toolSearch". If you need to use any of those tools, call them directly by name.
