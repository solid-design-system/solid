...
import type SdDropdown from '../dropdown/dropdown';
import type SdInput from '../input/input';
 ...
 * @dependency sd-input
 * @dependency sd-visually-hidden
 *
 * @slot label - The color picker's form label. Alternatively, you can use the `label` attribute.
 *
 * @event sd-change Emitted when the color picker's value changes.
 * @event sd-input Emitted when the color picker receives input.
 *
 ...
 */
@customElement('sd-color-picker')
export default class SdColorPicker extends SolidElement implements SolidFormControl {
  ...
  private handleInputChange(event: CustomEvent) {
    ...
    // Prevent the <sd-input>'s sd-change event from bubbling up
  ...
  private handleInputInput(event: CustomEvent) {
    // Prevent the <sd-input>'s sd-input event from bubbling up
    event.stopPropagation();
  }
  ...
  reportValidity() {
    if (!this.inline && !this.checkValidity()) {
      ...
      this.dropdown.show();
      this.addEventListener('sd-after-show', () => this.input.reportValidity(), { once: true });
  ...
  render() {
      ...
      >
        ...
        <div class="color-picker__user-input" aria-live="polite">
          <sd-input
            ...
            @sd-change=${this.handleInputChange}
            @sd-input=${this.handleInputInput}
          ></sd-input>
    ...
    return html`
      <sd-dropdown
        ...
        ?disabled=${this.disabled}
        ?hoist=${this.hoist}
        @sd-after-hide=${this.handleAfterHide}
      >
        <button
          part="trigger"
          slot="trigger"
