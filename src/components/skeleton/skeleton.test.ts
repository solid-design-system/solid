...
import type SdSkeleton from './skeleton';

describe('<sd-skeleton>', () => {
  it('should render default skeleton', async () => {
    const el = await fixture<SdSkeleton>(html` <sd-skeleton></sd-skeleton> `);
  ...
  it('should set pulse effect by attribute', async () => {
    const el = await fixture<SdSkeleton>(html` <sd-skeleton effect="pulse"></sd-skeleton> `);
  ...
  it('should set sheen effect by attribute', async () => {
    const el = await fixture<SdSkeleton>(html` <sd-skeleton effect="sheen"></sd-skeleton> `);
