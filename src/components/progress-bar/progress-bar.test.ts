...
describe('<sd-progress-bar>', () => {
  ...
  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<SdProgressBar>(html`<sd-progress-bar value="25"></sd-progress-bar>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<SdProgressBar>(
        html`<sd-progress-bar title="Titled Progress Ring" value="25"></sd-progress-bar>`
      );
  ...
  describe('when provided an indeterminate parameter', () => {
    ...
    before(async () => {
      el = await fixture<SdProgressBar>(
        html`<sd-progress-bar title="Titled Progress Ring" indeterminate></sd-progress-bar>`
      );
      base = el.shadowRoot!.querySelector('[part~="base"]')!;
    });
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<SdProgressBar>(
        html`<sd-progress-bar ariaLabel="Labelled Progress Ring" value="25"></sd-progress-bar>`
      );
    });
    ...
    before(async () => {
      el = await fixture<SdProgressBar>(
        html`
          ...
          <sd-progress-bar ariaLabelledBy="labelledby" value="25"></sd-progress-bar>
        `
      );
    });
