...
const newRealSize = getReadableSize(fs.statSync('./cdn/solid-components.iief.js').size);
const newGzipSize = getReadableSize(gzipSync(fs.readFileSync('./cdn/solid-components.iief.js')).byteLength);
