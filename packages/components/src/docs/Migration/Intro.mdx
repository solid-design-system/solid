...
- ui-superteaser: This component is replaced by `sd-video`.
...
- ui-qr-code: The component is not widely used across projects or by the target audience, making it unnecessary to maintain.
...
- ui-surrounding-map: This component was heavily dependent on the Google Maps API and had often changing requirements.
