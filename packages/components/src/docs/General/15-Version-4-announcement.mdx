...
# Solid Design System goes Version 4

Dear Community,

Today we're super excited to release the first major rewrite of our documentation in Storybook and Figma to better serve the needs of our direct users: **_You!_**
...
- **Plain Stories**: Our new stories are written in straightforward HTML, JS, and CSS, making it easier to copy and reuse code directly from our library.

## Included BREAKING CHANGES

With the documentation overhaul, we also needed to make several infrastructure changes, which introduced breaking changes to certain components. These changes were included in this release to minimize the need for future major version updates. Below is a list of the breaking changes for each affected component:
- tbd
- tbd
