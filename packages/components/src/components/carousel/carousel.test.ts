...
//     it('should scroll forwards every 30000 milliseconds', async () => {
//       // Arrange
...
//   describe('carousel is scrollable', () => {
//     it('should make the scrollable along the x-axis', async () => {
//       // Arrange
//       const el = await fixture<SdCarousel>(html`
//         <sd-carousel orientation="horizontal" style="height: 100px">
//           <sd-carousel-item>Node 1</sd-carousel-item>
//           <sd-carousel-item>Node 2</sd-carousel-item>
//         </sd-carousel>
//       `);
