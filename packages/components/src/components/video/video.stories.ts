          ...
          constants: [
            {
              ...
              name: 'default',
              value:
                '<video controls id="videoExample" style="min-width: 854px; min-height: 480px;"><source src="http://media.w3.org/2010/05/sintel/trailer.mp4" type="video/mp4" />Your browser does not support the video tag.</video>'
            },
            {
              type: 'slot',
              name: 'poster',
