...
/**
 * The component gets the `invalid` state when the form is not valid. For an invalid radio-group (since radios always come in groups) an error-text underneath the group is mandatory.
 */
