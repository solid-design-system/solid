  ...
  render() {
    ...
    return html`
      <span
        ...
        part="base"
        class=${cx(
          `inline-flex items-center gap-x-[1px] justify-center text-center leading-normal whitespace-nowrap border rounded-full select-none cursor-[inherit]`,
          {
            /* variants */
          ...
          }[this.variant],
          {
            ...
            md: 'h-4 px-[3px] min-w-[16px] text-[11px]',
