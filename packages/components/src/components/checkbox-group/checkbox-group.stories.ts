...
/**
 * Dev: This shows sd-checkbox-group in its Dev state.
 */
  ...
  render: (args: any) => {
    return html`
      <form action="" method="get" id="testForm" name="testForm" class="w-[370px]">
        <sd-checkbox-group
          ><sd-checkbox required form="testForm" name="field-1" value="1">Checkbox 1</sd-checkbox
          ><sd-checkbox form="testForm" name="field-2" value="2">Checkbox 2</sd-checkbox
          ><sd-checkbox form="testForm" name="field-3" value="3">Checkbox 3</sd-checkbox>
        </sd-checkbox-group>
      ...
      <script>
        function handleSubmit(event) {
          ...
          const sdCheckboxes = Array.from(document.querySelectorAll('sd-checkbox'));

          const isValid = sdCheckbox => sdCheckbox.checkValidity();

          if (sdCheckboxes.every(isValid)) {
