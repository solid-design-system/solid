  ...
  render() {
    ...
    return html`
      <div
        part="base"
        class=${cx(
          'inline-flex justify-center min-w-max items-center h-12 px-3 leading-none elect-none cursor-pointer group relative focus-visible:focus-outline outline-2 !-outline-offset-2',
