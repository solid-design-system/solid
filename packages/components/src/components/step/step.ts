...
/**
 * @summary Used to determine a step in a process or task inside `sd-step-group`.inside `sd-step-group`.inside `sd-step-group`.
      ...
      >
        ...
        >
          ...
          ${
            isHorizontalInline
              ? html`
                  <div class=${cx(!this.noTail && 'flex-1', 'flex flex-col gap-1')}>
                    <div
                      class=${cx(
                        'flex w-full',
                        hasLabel && 'gap-2',
