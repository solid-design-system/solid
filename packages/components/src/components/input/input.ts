      ...
      <div part="form-control" class=${cx((this.disabled || this.visuallyDisabled) && 'cursor-not-allowed')}>
        ...
        >
          ...
          >
                    ...
                    ${this.passwordVisible
                      ? html`
                          <slot name="show-password-icon"
                            ><sd-icon class=${cx(iconColor, iconSize)} library="internal" name="eye"></sd-icon
                          ></slot>
                        `
                      : html`
            ...
            ${this.type === 'time'
              ? html`
                  <sd-icon class=${cx(iconColor, iconMarginLeft, iconSize)} library="internal" name="clock"></sd-icon>
                `
              : ''}
            ${this.type === 'search'
              ? html`
