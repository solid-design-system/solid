...
export const icons = {
  ...
  mute: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M10.72 4.08a1 1 0 0 0-1.1.21L5.93 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.92l3.7 3.7a1 1 0 0 0 .71.3h.01a1 1 0 0 0 .38-.08 1 1 0 0 0 .61-.92V5a1 1 0 0 0-.6-.92zM4 10h1.33v4H4zm5.33 6.59-2-2V9.4l2-2zm12.38-8.96a1 1 0 0 0-1.42 0l-2.96 2.96-2.96-2.96a1 1 0 0 0-1.41 1.41L15.92 12l-2.96 2.96a1 1 0 0 0 1.41 1.41l2.96-2.96 2.96 2.96a1 1 0 0 0 1.42-1.41L18.75 12l2.96-2.96a1 1 0 0 0 0-1.41"/>
    </svg>
  `,
  volume: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  reload: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15">
      <path d="M1.42 5.928 2.533 7.04C2.615 3.073 5.629 0 9.45 0a7.223 7.223 0 0 1 0 14.445.834.834 0 0 1 0-1.667 5.556 5.556 0 0 0 0-11.111c-2.944 0-5.173 2.285-5.278 5.35l1.111-1.09a.834.834 0 0 1 1.178 1.18l-2.519 2.52a.83.83 0 0 1-1.18 0L.244 7.108a.835.835 0 0 1 1.18-1.18h-.003Z"/>
    </svg>
  `
};
