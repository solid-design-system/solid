...
export const icons = {
  ...
  `,
  'chevron-right': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.667 2.257a1 1 0 1 0-1.336 1.485l.002.001L15.506 12l-9.173 8.257a1 1 0 0 0 1.336 1.485l-.002.001 10-9a.997.997 0 0 0 .001-1.486l-.001-.001-10-8.999Z"/></svg>`,
  'chevron-left': `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  'status-check': `
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 21">
      <path fill="currentColor" d="M10 .5C4.477.5 0 4.977 0 10.5s4.477 10 10 10 10-4.477 10-10-4.477-10-10-10Zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16Z"/>
      <path fill="currentColor" d="M13.843 5.973a.999.999 0 0 0-1.367.329l-.002.004-3.667 6.223-1.757-1.753a1 1 0 0 0-1.413 1.414l-.001-.001 2.667 2.667a.997.997 0 0 0 .695.31h.128c.314-.042.578-.223.731-.479l.003-.005 4.333-7.333a1 1 0 0 0-.345-1.374l-.005-.003v.001Z"/>
    </svg>
  `,
  'status-minus': `
