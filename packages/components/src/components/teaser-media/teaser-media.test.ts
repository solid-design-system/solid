...
describe('<sd-teaser-media>', () => {
  ...
  it('renders assigned values correctly', async () => {
    const el = await fixture<SdTeaserMedia>(
      html`<sd-teaser-media variant="neutral-100" breakpoint="9999" inset></sd-teaser-media>`
    );
  ...
  describe('applies --distribution-media and --distribution-content CSS properties correctly', () => {
    it('--distribution-media is 70% and --distribution-content 30%', async () => {
      const el = await fixture<SdTeaserMedia>(html`
        <sd-teaser-media style="--distribution-media: 70%; --distribution-content: 30%;">
          <div slot="media">Media</div>
          <div slot="meta">Meta</div>
          <div slot="headline">Headline</div>
          <div slot="main">Main</div>
    ...
    it('--distribution-media is fixed 400px', async () => {
      const el = await fixture<SdTeaserMedia>(html`
        <sd-teaser-media style="--distribution-media: 400px; width:500px;">
          <div slot="media">Media</div>
          <div slot="meta">Meta</div>
          <div slot="headline">Headline</div>
          <div slot="main">Main</div>
    ...
    it('does not apply --distribution-media and --distribution-content CSS properties when breakpoint is 9999', async () => {
      const el = await fixture<SdTeaserMedia>(html`
        <sd-teaser-media style="--distribution-media: 30%; --distribution-content: 70%; width:400px;">
          <div slot="media">Media</div>
          <div slot="meta">Meta</div>
          <div slot="headline">Headline</div>
          <div slot="main">Main</div>
  ...
  describe('breakpoints', () => {
    describe('default breakpoint', () => {
      it('check if state is vertical', async () => {
        const el = await fixture<SdTeaserMedia>(html`<sd-teaser-media style="width:400px;"></sd-teaser-media>`);
      ...
      it('check if state is horizontal', async () => {
        const el = await fixture<SdTeaserMedia>(html`<sd-teaser-media style="width:600px;"></sd-teaser-media>`);
    ...
    describe('manual breakpoint', () => {
      it('check if state is vertical', async () => {
        const el = await fixture<SdTeaserMedia>(
          html`<sd-teaser-media style="width:400px;" breakpoint="999"></sd-teaser-media>`
        );
      ...
      it('check if state is still vertical', async () => {
        const el = await fixture<SdTeaserMedia>(html`<sd-teaser-media style="width:800px;"></sd-teaser-media>`);
      ...
      it('check if state is horizontal', async () => {
        const el = await fixture<SdTeaserMedia>(html`<sd-teaser-media style="width:1000px;"></sd-teaser-media>`);
  ...
  it('keeps inset property as false after changing variant', async () => {
    const el = await fixture<SdTeaserMedia>(
      html`<sd-teaser-media variant="white border-neutral-400"></sd-teaser-media>`
    );
