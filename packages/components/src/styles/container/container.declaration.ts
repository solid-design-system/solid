...
export default {
  ...
  attributes: [
    ...
    },
    {
      ...
      description:
        'Defines optional triangle cut-out for sd-container. This allows for an indentation resembling an arrow on any side of the container. CSS Property `triangle-background` defines the background color of the cut-out.'
    }
  ]
} satisfies Style;
