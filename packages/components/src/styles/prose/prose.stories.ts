...
/**
 * The `sd-prose` component resets the styles of a prose to predefined values. To style prose cells use the `sd-prose-cell` component.
 */
...
export const Default = {
  render: () => {
    return html`<div class="sd-prose">
      <h1>Solid Prose</h1>
      <p>
...
&lt;/article&gt;
  ...
  plugins: [],
      ...
      <p>
        ...
        the same size as the body copy. What are we supposed to do with an <code>h5</code>, make it
