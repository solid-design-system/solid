...
/**
 * ####Chips:
 * - Should be used to label a status, property or metadata.
 * - Preferred position is upper left hand side on top
 *
 * ####Flags:
 * - Should be used to label categories
 * - Preferred position is upper right hand side (without padding-right).
 */
 ...
 * - `primary-200`: on background.white
 * - `primary-300`: on background.primary-100
 * - `primary-500`: on background.primary
 * - `white`: on background image
 */
