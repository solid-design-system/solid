        ...
        <sd-expandable>
          <div class="sd-paragraph h-full">
            <p>
              ...
              and inclusive working environment is important to us. We benefit from the perspectives of different
              genders, age groups, educational levels and backgrounds, thus guaranteeing that we are successful
              together.
            </p>
            <p>
            ...
            <p>
              ...
              within the company. We want to attract and retain the best candidates, irrespective of cultural or social
              background, ethnicity, gender, sexual orientation, disability, religion or age. To do this, we have
              created a working environment that is free of prejudice, where respect is paramount and people can achieve
              their full potential. This is the policy that underpins the actions of our managers and employees.
            </p>
          </div>
        </sd-expandable>
      </div>
    ...
    html`<div class="flex flex-col gap-4">
      <div class="background-sample bg-neutral-100 p-4">
        ...
        >
          ...
          <p class="sd-leadtext">US inflation soon to reach its cyclical low</p>
          <p class="sd-leadtext">
      ...
      <div class="background-sample bg-neutral-100 p-4">
        ...
        >
          ...
          US inflation soon to reach its cyclical low
          <div class="sd-paragraph">
            Our judgement on inflation is mixed. Although the global trend of falling inflation is continuing, it is
            slowing down. In the US, the cyclical low in core inflation, i.e. the price trend excluding energy and food,
            is likely to be reached in the summer. However, inflation remains above the US Federal Reserve's inflation
