...
- Multi-Calculator Selection Panel (optional): If needed this panel lets a user switch between different specialised calculators related to the aforementioned topic.
...
- Calcualtor Head: Contains a title that clearly communicates the purpose (e.g., “Savings Plan Calculator”) and a short description that sets expectations about this specific Step.
