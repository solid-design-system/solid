...
## Template: Unclickable Teaser with Button

```html
<sd-teaser variant="white border-neutral-400" breakpoint="9999" inset class="flex-1 flex flex-col max-w-[426.67px]">
  ...
  <div class="flex flex-col gap-5 mt-4">
    <p>
      Our experts assess current economic developments and topics for your investment decision. All analyses, white
      papers and studies can be found here.
    </p>
    <div class="flex-none">
...
<div class="max-w-[426.67px]">
  <sd-teaser variant="primary-100" inset class="clickable relative m-2 translate-x-0 translate-y-0">
    ...
    <p class="mb-8">
      Climate change is one of the greatest global challenges. Global warming threatens to have a massive impact on
      human coexistence, the living conditions of each individual and economic development. As an asset manager, Union
      Investment is facing up to the challenges associated with combating climate change and the sustainable
...
<div class="flex flex-col gap-8">
  ...
  <sd-teaser variant="primary" breakpoint="9999" inset class="flex-1 max-w-[338px]">
    ...
    <h3 slot="headline" class="sd-headline sd-headline--size-lg sd-headline--inverted">Subscribe to our newsletter!</h3>
    <div class="flex flex-col gap-5">
      <p class="sd-paragraph sd-paragraph--inverted mt-2">
        ...
        studies, stories, transactions, events and editorial articles from our places and spaces magazine. Stay up to
        date!
      </p>
      <div class="flex-none">
  ...
  >
    ...
    <div class="flex flex-col gap-5">
      <p class="sd-paragraph">
        We take responsibility and act responsibly in the sense of our fiduciary mandate towards our investors as well
        as towards our employees and society.
      </p>
  ...
  <sd-teaser variant="white border-neutral-400" breakpoint="9999" inset class="relative max-w-[320px]">
    ...
    <div class="flex flex-col gap-5">
      <p class="sd-paragraph mt-2">
        At the beginning of June this year, the European Central Bank (ECB) cut interest rates for the first time in
        almost five years: by 0.25 points to 4.25 per cent.
      </p>
      <div class="flex-none">
...
## Template: Teaser with 50:50 Division
...
>
  ...
  <div class="w-full flex flex-col h-full justify-between pt-4 gap-2">
    <p class="sd-paragraph">
      The opportunities for asset classes in challenging times are being explored, particularly within the context of
      open real estate mutual funds.
    </p>
