...
```html
<p class="sd-display mb-6">size 4xl</p>
<div class="text-left text-black mb-12">
  ...
  <div class="gap-6 flex items-center">
    <img class="w-16 h-16 rounded-full overflow-hidden object-cover" src="./placeholders/images/profile.png" alt="" />
    <div>
...
## Template: Quote Inverted

```html
<div class="flex items-end gap-5 p-5 bg-primary">
...
## Template: Quote without Profile Image
