...
## Template: Quickfact with Summary

```html
<sd-quickfact class="max-w-[410px] mx-auto">
...
## Template: Quickfact with Description
...
<sd-quickfact>
  ...
  <div slot="summary" class="space-y-4">
    ...
    <p class="text-base font-normal leading-normal md:text-xl">
      Union Investment is part of the Volksbanken Raiffeisenbanken cooperative financial network. The cooperative model
      is based on a simple idea: when people join forces, they are much stronger together: "What one cannot do alone,
      many can".
    </p>
  </div>
</sd-quickfact>
