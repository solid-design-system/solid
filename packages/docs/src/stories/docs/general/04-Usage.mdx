...
Besides Web Components we provide a set of CSS classes that can be used to style your application. They follow the [BEM](http://getbem.com/) methodology and are mainly used when building a full-fledged component would be way too much or could harm a11y.
