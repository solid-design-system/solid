...
<h1 className="sd-headline sd-headline--size-3xl">Accessibility at Union Investment</h1>
...
- With responsive layouts and zoom functions, texts must remain legible even when enlarged by 200%. Texts that are too long may be broken or cut off.
...
- Ensure that all text remains fully readable and functional when enlarged to 200%.

**Figma Accessibility Tools (besides native feature)**
