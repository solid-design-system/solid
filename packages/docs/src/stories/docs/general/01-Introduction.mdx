...
<div class="flex space-between">
  <q class="text-lg">We are the sustainable foundation for all digital products that strengthens the brand, is user-friendly and accessible. We enable and guide designers and developers to use it productively and with confidence.</q>

  <img src="/solid.png" class="h-[200px] max-w-full" />
</div>
