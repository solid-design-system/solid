...
<h1 className="sd-headline sd-headline--size-3xl">Introduction</h1>

<div className="mb-12! flex flex-col gap-6 space-between md:flex-row md:items-center">
  <img src="./images/logo-unioninvestment-lg.svg" alt="Union Investment" className="h-auto w-[250px] object-contain" />

  <p>With over 6 million clients, Union Investment is one of Germany's leading fund management companies. As part of the Genossenschaftliche FinanzGruppe, we offer investment solutions for private clients, institutional clients, and real estate clients in a constantly changing environment.</p>
</div>

## Solid Design System

<div className="flex flex-col gap-6 space-between md:flex-row">
  <q className="text-lg">We are the sustainable foundation for all digital products that strengthens the brand, is user-friendly and accessible. We enable and guide designers, developers and agents to use it productively and with confidence.</q>
...
- **Thorough testing**: High test coverage with E2E-Tests via Playwright (<sd-link href={`https://github.com/microsoft/playwright/releases/tag/v${playwrightVersion}`} target="\_blank">tested Browser versions</sd-link>) and Visual Regression Tests via Chromatic (<sd-link href="https://www.chromatic.com/docs/infrastructure-release-notes" target="_blank">current Browser versions</sd-link>).
