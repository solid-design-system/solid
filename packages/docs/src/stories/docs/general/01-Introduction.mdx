...
- **Thorough testing**: High test coverage with E2E-Tests via Playwright (<a href={`https://github.com/microsoft/playwright/releases/tag/v${playwrightVersion}`} target="\_blank" className="underline! transition-colors text-primary! hover:text-primary-500! active:text-primary-800!">tested Browser versions</a>) and Visual Regression Tests via Chromatic ([current Browser versions](https://www.chromatic.com/docs/infrastructure-release-notes)).
