...
<Meta title="Docs/Migration/ui-flashcard" />
...
6. [ratio]
   - The ratio attribute has been removed. Use the `base` CSS part to set custom aspect ratio of the flipcard. See this [sample](https://solid-design-system.fe.union-investment.de/docs/?path=/docs/components-sd-flipcard--docs#sample%3A%20aspect%20ratio) for more information.
7. [transition-delay]
