...
export const storybookLink = '/?path=/docs/styles-sd-prose--docs';
...
- Avoid skipping heading levels, such as from <h2> to <h4>, going down the page. Assistive technologies rely on heading tags to convey a logical structure.
...
<OverviewFormatter story={ProseStories.Default}>{content}</OverviewFormatter>
