...
- Use proper HTML table elements (e.g., <table>, <thead>, <tbody>, <tr>, <th>, <td>) to ensure screen readers can correctly interpret table headers and cell data..
...
<OverviewFormatter story={TableCellStories.Default}>{content}</OverviewFormatter>
