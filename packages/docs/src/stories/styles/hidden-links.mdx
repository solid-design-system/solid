...
import * as SdHiddenLinksStories from './hidden-links.stories';
...
- [Dropdown with Navigation Items](/http://localhost:6999/?path=/docs/templates-dropdown--docs)
...
<OverviewFormatter story={SdHiddenLinksStories.Default}>{content}</OverviewFormatter>
