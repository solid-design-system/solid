...
<sd-tab-group>
  ...
  <sd-tab-panel name="unversioned">
    ...
    <link
      rel="stylesheet"
      href="https://solid-design-system.union-investment.com/styles/%STYLES-VERSION%/cdn/index.css"
    />
    ```
  </sd-tab-panel>
  <sd-tab-panel name="versioned">
    ...
    <link
      rel="stylesheet"
      href="https://solid-design-system.union-investment.com/styles/%STYLES-VERSION%/cdn-versioned/index.css"
    />
    ```
  </sd-tab-panel>
</sd-tab-group>
...
<sd-tab-group>
  ...
  <sd-tab-panel name="unversioned">
    ```html
    <link rel="stylesheet" href="/solid/dist/index.css" />
    ```
  </sd-tab-panel>
  <sd-tab-panel name="versioned">
    ```html
    <link rel="stylesheet" href="/solid/dist-versioned/index.css" />
    ```
  </sd-tab-panel>
</sd-tab-group>
