...
<sd-tab-group>
  ...
  <sd-tab-panel name="unversioned">
    ...
    <link
      rel="stylesheet"
      href="https://solid-design-system.union-investment.com/styles/%STYLES-VERSION%/cdn/solid-styles.css"
    />
    ```
  </sd-tab-panel>
  <sd-tab-panel name="versioned">
    ...
    <link
      rel="stylesheet"
      href="https://solid-design-system.union-investment.com/styles/%STYLES-VERSION%/cdn-versioned/solid-styles.css"
    />
    ```
  </sd-tab-panel>
</sd-tab-group>
