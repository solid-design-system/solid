...
for that particular story. This can useful for drafts or components under development
...
1. **Local the `browser` URL:** When an a11y test fails, it outputs a URL pointing to the rendered story.
