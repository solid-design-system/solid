...
- All deprecated variables are clearly marked and recommended replacements provided in the <sd-link href="?path=/docs/packages-tokens-usage--docs">Usage</sd-link> page under "Deprecated CSS variables (tokens)"
