...
```html
<sd-expandable>
  <sd-icon slot="toggle-open" class="mr-2 text-xl" library="_internal" name="chevron-top"></sd-icon>
  <span slot="toggle-open"> <!-- Collapse --> </span>

  <sd-icon slot="toggle-closed" class="mr-2 text-xl" library="_internal" name="chevron-bottom"></sd-icon>
...
```html
<sd-expandable>
  <sd-icon slot="expand-icon" class="mr-2 text-xl" library="_internal" name="chevron-bottom"></sd-icon>
  <span slot="toggle-closed"> <!-- Expand --> </span>

  <sd-icon slot="collapse-icon" class="mr-2 text-xl" library="_internal" name="chevron-bottom"></sd-icon>
  <span slot="toggle-open"> <!-- Collapse --> </span>
</sd-expandable>
```
