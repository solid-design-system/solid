    ...
    <sd-tab-group>
      ...
      <sd-tab-panel name="unversioned">
        ...
        **Before:**
        ...
        ```html
        <link rel="stylesheet" href="https://solid-design-system.fe.union-investment.de/3.24.0/styles/solid-styles.css" />
        <!-- <sd-alert> is usable, .sd-mark is available -->
        ```
      ...
      <sd-tab-panel name="versioned">
        **Before:**
        ...
        ```html
        <link rel="stylesheet" href="https://solid-design-system.fe.union-investment.de/3.24.0/versioned-styles/solid-styles.css" />
        <!-- <sd-3-24-0-alert> is usable, .sd-3-24-0-mark is available -->
        ```

        **After:**

        ```html
        <link rel="stylesheet" href="https://solid-design-system.fe.union-investment.de/components/%COMPONENTS-VERSION%/cdn-versioned/solid-components.css" />
        <!-- <sd-%DASHED-COMPONENTS-VERSION%-alert> is usable -->

        <link rel="stylesheet" href="https://solid-design-system.fe.union-investment.de/styles/%STYLES-VERSION%/cdn-versioned/solid-styles.css" />
        <!-- .sd-%DASHED-STYLES-VERSION%-mark is available -->
        ```
    ...
    <sd-tab-group>
      ...
      <sd-tab-panel name="unversioned">
        **Before:**
        ...
        ```javascript
        <script type="module" src="https://solid-design-system.fe.union-investment.de/3.24.0/components/es/solid-components.js"></script>
        ```
      ...
      <sd-tab-panel name="versioned">
        **Before:**
        ...
        ```javascript
        <script type="module" src="https://solid-design-system.fe.union-investment.de/3.24.0/versioned-components/es/solid-components.js"></script>
        ```

        **After:**

        ```javascript
        <script type="module" src="https://solid-design-system.fe.union-investment.de/components/%COMPONENTS-VERSION%/cdn-versioned/solid-components.js"></script>
        ```
...
```html
<script src="https://solid-design-system.fe.union-investment.de/3.24.0/components/umd/solid-components.js"></script>
...
The `sd-badge` component has been updated to improve a11y.

`variant` attribute options have been renamed to clearly remove any semantic meaning. The variants should only communicate a state visually.
