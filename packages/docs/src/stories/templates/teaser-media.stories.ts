...
export const TeaserMediaWithLink = {
  ...
  render: () =>
    html` <div class="flex flex-col gap-12">
      ...
      <script type="module">
        const teaserMediaNeutralWithButtonBackground = document
          .querySelector('.teaser-neutral-100')
          .shadowRoot.querySelector('.teaser-media-background');
        const teaserMediaNeutralButton = document.querySelector('.teaser-neutral-100').querySelector('sd-button');

        teaserMediaNeutralWithButtonBackground.addEventListener('sd-focus', event => {
          if (event.target !== teaserMediaNeutralButton) return;
          teaserMediaNeutralWithButtonBackground.classList.remove('bg-neutral-100/[.8]');
          teaserMediaNeutralWithButtonBackground.classList.add('bg-neutral-100/90');
        });

        teaserMediaNeutralWithButtonBackground.addEventListener('sd-blur', event => {
          if (event.target !== teaserMediaNeutralButton) return;
          teaserMediaNeutralWithButtonBackground.classList.remove('bg-neutral-100/90');
          teaserMediaNeutralWithButtonBackground.classList.add('bg-neutral-100/[.8]');
        });
      </script>`
};
