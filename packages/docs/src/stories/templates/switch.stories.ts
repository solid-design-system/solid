...
export default {
  ...
  parameters: {
    relatedLinks: ['components/sd-switch', 'components/sd-tooltip'],
...
export const Default = {
  ...
  render: () => html`
    <style>
      #anchor--templates-switch--default .innerZoomElementWrapper {
        min-height: 300px;
      }
    </style>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 ">
      ...
      <sd-select label="Recommended investment horizon" placeholder="Please select" max-options-visible="3">
