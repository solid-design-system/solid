  ...
  render: () => html`
    ...
    <section tabindex="0" aria-label="Simple table" class="focus-visible:focus-outline">
      <table id="multi-select-table" class="sd-table sample-table w-full">
        <thead>
          <tr>
            <th class="sd-table-cell sd-table-cell--bg-white" role="rowheader">
              <sd-checkbox class="hide-label" id="select-all" size="sm" indeterminate>Header</sd-checkbox>
            </th>
        ...
        <tbody class="selectable-rows">
          ...
          <tr>
            <td class="sd-table-cell sd-table-cell--bg-transparent">
              <sd-checkbox class="hide-label" size="sm" checked label="empty"></sd-checkbox>
            </td>
            <td class="sd-table-cell sd-table-cell--bg-transparent">
