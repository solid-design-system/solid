...
test('Docs', async ({ page }) => {
  await page.goto('http://127.0.0.1:6998/iframe.html?globals=&args=&id=templates-flipcard--docs&viewMode=story');
  await expect(page.locator('body')).toMatchAriaSnapshot(`
    ...
    - paragraph: Example on how to use flipcard component.
    - code
