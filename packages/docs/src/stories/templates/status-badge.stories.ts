 ...
 *
 * __Code-only__: The icons used in this component, should be exclusively from the status-assets [icon library](https://solid-design-system.fe.union-investment.de/docs/?path=/story/components-sd-icon-libraries--status-library).
 */
