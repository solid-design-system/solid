...
export const storybookLink = '/?path=/docs/components-sd-combobox--docs';
...
export const figmaDocs =
  'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=8945-6965&node-type=section&t=nhfiCjbYf0AZNQe5-11';
