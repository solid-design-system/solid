...
export const figmaLibrary =
  'https://www.figma.com/design/VTztxQ5pWG7ARg8hCX6PfR/Solid-DS-%E2%80%93-Component-Library?node-id=35987-7115&t=jtzgSPp7yWU3gUFa-4';
...
<OverviewFormatter story={AccordionStories.Default}>{content}</OverviewFormatter>
