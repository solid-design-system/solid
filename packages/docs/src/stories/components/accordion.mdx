...
export const links = {
  'storybook-docs': './?path=/docs/components-sd-accordion--docs',
  'figma-library':
  ...
  'figma-docs':
    'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=12832-5731&t=Ofp8VZp7ENrfyAEL-0'
};
...
<OverviewFormatter story={SdAccordionStories.Default} tag="sd-accordion">
  {content}
</OverviewFormatter>
