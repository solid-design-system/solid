...
- When using the expandable slot make sure it does not contain any action since it is not shown on mobile devices due to hover interaction. The slot should only conceal supplementary, non-essential content.
