...
export const storybookLink = '/?path=/docs/components-sd-checkbox-group--docs';
...
export const figmaDocs =
  'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=2216-25185&t=pFHk5gNX1Hj4l15o-4';
...
- Check sd-checkbox for single usage guidelines.
