...
export const storybookLink = '/?path=/docs/components-sd-radio-group--docs';
...
export const figmaDocs = 'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=11505-6863&m';
