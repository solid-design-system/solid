 ...
 * Solid ships with four built-in icon libraries, `default`, `_internal`, `sd-status-assets` and `multi-theming`:
 ...
 * - `multi-theming`: This library contains icons specifically designed for multi-theming.
 *
