...
export const storybookLink = '/?path=/docs/components-sd-checkbox--docs';
export const figmaLibrary =
  'https://www.figma.com/design/VTztxQ5pWG7ARg8hCX6PfR/Solid-DS-%E2%80%93-Component-Library?node-id=88-1057&p=f&t=B5mgTBjcWeycmzb6-0';
...
- Check sd-checkbox-group for group use cases and usage guidelines.
...
- Refrain from using a single checkbox when the action should take effect immediately—use sd-switch instead.
...
<OverviewFormatter story={CheckboxStories.Default}>{content}</OverviewFormatter>
