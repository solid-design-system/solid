...
export const storybookLink = '/?path=/docs/components-sd-tag--docs';
...
- When removable, provide an accessible name for the remove action (e.g., aria-label="Remove [tag label] tag").
