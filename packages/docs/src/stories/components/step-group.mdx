...
import * as SdStepGroupStories from './step-group.stories';

export const storybookLink = '/?path=/docs/components-sd-step-group--docs';
export const figmaLibrary =
  'https://www.figma.com/design/VTztxQ5pWG7ARg8hCX6PfR/Solid-DS-%E2%80%93-Component-Library?node-id=29686-5066&t=dqUeMkGMUcuu6OfL-4';
export const figmaDocs = 'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=12380-3417&m';
...
<OverviewFormatter story={SdStepGroupStories.Default}>{content}</OverviewFormatter>
