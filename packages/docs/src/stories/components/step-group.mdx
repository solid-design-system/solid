...
export const links = {
  'storybook-docs': '/?path=/docs/components-sd-step-group--docs',
  'figma-library':
  ...
  'figma-docs': 'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=12380-3417&m'
};
