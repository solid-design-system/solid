...
- The use of sd-accordion is generally recommended over the use of [sd-expandable](?path=/docs/components-sd-expandable--docs): accordions give the user a quick scan header to decide if the content is relevant to them, offer a cleaner layout and are more accessible as a result.
