...
export const Default = {
  render: (args: any) => {
    return html`<div class="h-[500px] w-full max-w-[370px]">${generateTemplate({ args })}</div>`;
  }
};
...
export const Size = {
  render: () => html`
    <div class="flex flex-col gap-4 w-full max-w-[370px] h-[500px]">
...
export const Alignment = {
  render: () =>
    html` <div class="w-full max-w-[370px] h-[500px]">
...
export const FloatingLabel = {
  render: () => html`
    <div class="flex gap-12 h-[500px] w-full max-w-[370px]">
...
export const HelpText = {
  render: () =>
    html`<div class="flex flex-wrap md:flex-nowrap gap-12 h-[500px] w-full max-w-[370px]">
      <sd-datepicker
        label="Label"
...
export const Valid = {
  render: () => html`
    <div class="w-full max-w-[370px] h-[500px]">
