...
export const storybookLink = '/?path=/docs/components-sd-option--docs';
...
export const figmaDocs = 'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=9809-71199&m';
