...
export const links = {
  ...
  'figma-library':
    'https://www.figma.com/design/VTztxQ5pWG7ARg8hCX6PfR/Solid-DS-%E2%80%93-Component-Library?node-id=61919-1818&p=f&t=WJ35PqPNNCiwdvLU-0',
  'figma-docs':
    'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Solid-DS-%E2%80%93-Component-Docs?node-id=24003-6863&p=f&t=qjTZ3FNSKejocm9C-0'
};
