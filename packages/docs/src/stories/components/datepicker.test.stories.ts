...
export const Default = {
  name: 'Default',
  render: (args: any) => {
    return html`<div class="max-w-[400px]">${generateTemplate({ args })}</div>`;
  }
};
...
export const MinAndMax = {
  name: 'Min and Max',
  render: () => {
    return html`<div class="max-w-[370px] h-[500px]">
...
export const Placement = {
  name: 'Placement',
  render: () => {
    return html`<div class="max-w-[400px] mt-[400px]">
...
export const LocaleAware = {
  name: 'Locale Aware',
  render: () => {
    return html`<div class="flex flex-col gap-4 max-w-[400px]">
