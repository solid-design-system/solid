...
export const storybookLink = '/?path=/docs/components-sd-video--docs';
...
export const figmaDocs = 'https://www.figma.com/design/YDktJcseQIIQbsuCpoKS4V/Component-Docs?node-id=12785-38790&m';
