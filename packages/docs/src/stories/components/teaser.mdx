...
import * as SdTeaserStories from './teaser.stories';

export const links = {
  'storybook-docs': '/?path=/docs/components-sd-teaser--docs',
  'figma-library':
...
<OverviewFormatter story={SdTeaserStories.Default}>{content}</OverviewFormatter>
