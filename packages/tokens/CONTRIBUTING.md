...
3. Run `cd packages/tokens && FIGMA_FILE_ID=[Set file id here, which is unique for every branche] FIGMA_TOKEN=[use the created token here] pnpm fetch:figma` and `pnpm build`
4. Enjoy.
